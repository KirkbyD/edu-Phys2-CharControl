...
#include "cDebugRenderer.hpp"

#include "../GLCommon.hpp"

#include "COpenGLError.hpp"
...
#include "cGLRenderStateHelper.hpp"
...
bool cDebugRenderer::m_InitBuffer(sVAOInfoDebug& VAOInfo)
{
	...
	vec_sVAOInfoDebug.push_back(VAOInfo);
...
cDebugRenderer::~cDebugRenderer()
{
	...
	for (auto a : vec_sVAOInfoDebug) {
		//TODO - causes pn exit crash???
		//delete a.pLocalVertexArray;
	}
