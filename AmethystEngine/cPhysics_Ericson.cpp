...
//}
//
//void cPhysics::ResetSteeringForce() { this->_steering_force = glm::vec3(1.0f, 1.0f, 1.0f); }
//void cPhysics::SetSteeringForce(glm::vec3 steeringForce) {this->_steering_force = steeringForce; }
//
...
//	w *= denom; // w = 1.0f - u - v;
//
//	// Compute closest point from barycentric coordinates
//	closestPoint = u * a + v * b + w * c;
//
//	return true;
//}
